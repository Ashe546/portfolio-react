...
export default function WhatIDo() {
    return (
        <div className='flex flex-col text-center justify-center mt-6' id='work'>
            ...
            <div className='grid p-4 md:p-6 md:grid-col-2  lg:px-32 py-4 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-4'>
                <div className='py-8 px-4 w-full h-fit card flex flex-col gap-3'>
                    ...
                    <h1>Web Developer </h1>
                    <p>Web Developer with 3 years of experience in designing and developing user interfaces, testing, debugging, and training staff within eCommerce technologies. Proven ability in optimizing web functionality that improve data retrieval and workflow efficiencies.</p>
                </div>
                <div className='py-8 px-4 w-full h-fit card flex flex-col gap-3'>
                    <div className='flex justify-center'>
                ...
                <div className='py-8 px-4 w-full h-auto card flex flex-col gap-3'>
                    <div className='flex justify-center'>
                        <img className='w-[70px] h-[70px]' src='/api.png' /><img />
                    </div>
                    <h1>Api Development</h1>
                    <p>An ingenious and resourceful professional seeking to build a long term career as an API Developer to help in organizational development owing to my expertise in React, Express.js , Javascript, Ruby and SQL.</p>
                </div>
                <div className='py-8 px-4 w-full h-auto card flex flex-col gap-3'>
                    <div className='flex justify-center'>
                    ...
                    <p>
                        Data-driven database designer with experience in designing and developing relational and non-relational databases. Skilled in data modeling, performance optimization, and query writing. Expertise in big data technologies and NoSQL solutions.
                    </p>
                </div>
                <div className='py-8 px-4 w-full h-auto card flex flex-col gap-3'>
                    <div className='flex justify-center'>
                ...
                <div className='py-8 px-4 w-full h-auto card flex flex-col gap-3'>
                    ...
                    <h1>Web Testing</h1>
                    Skilled Web Tester has three years of experience testing websites from an end-user role to ensure they function appropriately.Provides excellent documentation of usability issues and functionality.Has top-notch written communication skills and a Bachelor’s Degree in Mechanical Enginerring. </div>
            </div>
        </div>
    )
}
