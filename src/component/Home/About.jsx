...
export default function About() {
    return (
        <div className='flex flex-col text-center justify-center mt-6' id='about'>
            ...
            <div className='about grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-auto m-4 lg:mx-32 my-10'>
                ...
                <div className='grid grid-rows-2 p-3'>
                    ...
                    <div className='grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-2 lg:justify-items-start justify-items-center gap-3 p-3'>
                        ...
                        <div className='font-bold text-3xl'>12 <sup>+</sup></div>
                    ...
                    <div className='grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-2 lg:justify-items-start justify-items-center gap-3 p-3'>
                        ...
                        <div className='font-bold text-3xl'>24 <sup>+</sup></div>
                ...
                <div className='grid grid-rows-2 p-3'>
                    <div className='grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-2 lg:justify-items-start justify-items-center gap-3 p-3'>
                        ...
                        <div className='font-bold text-3xl'>43 <sup>+</sup></div>
                    ...
                    <div className='grid grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-2 lg:justify-items-start justify-items-center gap-3 p-3'>
                        ...
                        <div className='font-bold text-3xl'>3 <sup>+</sup></div>
