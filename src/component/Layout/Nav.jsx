        ...
        <div className="flex justify-end mt-3 mr-3">
            <div className={`border-2 border-sky-500 shadow-2xl w-fit ${toggle === true ? "rounded-tr-3xl" : "rounded-full"} bg-white lg:rounded-full flex fixed`}>
                <ul className={`${toggle === true ? "block lg:flex" : "hidden"} gap-8 lg:gap-5 py-10 lg:py-2 px-8`}>
                    <li className="font-medium text-lg hover:text-sky-500">Home</li>
                    <li className="font-medium text-lg hover:text-sky-500">About</li>
                    <li className="font-medium text-lg hover:text-sky-500">Resume</li>
                    <li className="font-medium text-lg hover:text-sky-500">Portfolio</li>
                    <li className="font-medium text-lg hover:text-sky-500">Contact</li>
                </ul>
